...
public class Start {
    ...
    public static void judgePruchase(String pid) throws IOException, ParseException, InterruptedException {
        ...
        if (shopDetail.get("yuyueInfo") != null) {
            ...
            Long startTime = HttpUrlConnectionUtil.dateToTime(startDate) - 200;
            while (true) {
